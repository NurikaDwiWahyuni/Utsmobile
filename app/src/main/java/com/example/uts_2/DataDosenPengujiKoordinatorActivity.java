...
public class DataDosenPengujiKoordinatorActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_data_dosen_penguji);
        ...
        tambahButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DataDosenPengujiKoordinatorActivity.this, TambahDospengActivity.class);
        ...
        namaDosen1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DataDosenPengujiKoordinatorActivity.this, EditDospengActivity.class);
                startActivity(intent);
            }
        });
